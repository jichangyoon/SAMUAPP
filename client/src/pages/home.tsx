            ...
            <div className="space-y-4">
              ...
              <div className="space-y-4">
                ...
                {[
                  {
                    id: 30,
                    title: "Contest #30 - December 2024",
                    participants: 78,
                    totalVotes: 2156,
                    status: "Completed",
                    memes: [
                      { id: 1, title: "SAMU ROCKET", author: "moon_shooter", votes: 445, rank: 1, imageUrl: "data:image/svg+xml,%3Csvg viewBox='0 0 400 400' xmlns='http://www.w3.org/2000/svg'%3E%3Crect width='400' height='400' fill='%23000080'/%3E%3Cpolygon points='200,50 220,150 180,150' fill='%23FF6B35'/%3E%3Ccircle cx='200' cy='200' r='30' fill='%23F7DC6F'/%3E%3Ctext x='200' y='300' text-anchor='middle' font-family='Arial' font-size='16' font-weight='bold' fill='white'%3EROCKET%3C/text%3E%3C/svg%3E", description: "To the moon and beyond!" },
                      { id: 2, title: "DIAMOND WOLF", author: "crypto_alpha", votes: 387, rank: 2, imageUrl: "data:image/svg+xml,%3Csvg viewBox='0 0 400 400' xmlns='http://www.w3.org/2000/svg'%3E%3Crect width='400' height='400' fill='%231a1a2e'/%3E%3Cpolygon points='200,100 250,150 200,200 150,150' fill='%2300BFFF'/%3E%3Ccircle cx='200' cy='250' r='40' fill='%23654321'/%3E%3Ctext x='200' y='340' text-anchor='middle' font-family='Arial' font-size='14' font-weight='bold' fill='white'%3EDIAMOND WOLF%3C/text%3E%3C/svg%3E", description: "Strongest diamond hands" },
                      { id: 3, title: "HODL FOREVER", author: "diamond_hands", votes: 298, rank: 3, imageUrl: "data:image/svg+xml,%3Csvg viewBox='0 0 400 400' xmlns='http://www.w3.org/2000/svg'%3E%3Crect width='400' height='400' fill='%232C3E50'/%3E%3Crect x='150' y='150' width='100' height='100' fill='%23F39C12'/%3E%3Ctext x='200' y='190' text-anchor='middle' font-family='Arial' font-size='12' font-weight='bold'%3EHODL%3C/text%3E%3Ctext x='200' y='220' text-anchor='middle' font-family='Arial' font-size='12' font-weight='bold'%3EFOREVER%3C/text%3E%3C/svg%3E", description: "Never selling!" }
                    ]
                  },
                  {
                    id: 29,
                    title: "Contest #29 - November 2024", 
                    participants: 65,
                    totalVotes: 1834,
                    status: "Completed",
                    memes: [
                      { id: 1, title: "WOLF PACK STRONG", author: "pack_leader", votes: 412, rank: 1, imageUrl: "data:image/svg+xml,%3Csvg viewBox='0 0 400 400' xmlns='http://www.w3.org/2000/svg'%3E%3Crect width='400' height='400' fill='%238B4513'/%3E%3Ccircle cx='200' cy='180' r='80' fill='%23D2691E'/%3E%3Cpath d='M160 160 L200 120 L240 160 L220 200 L180 200 Z' fill='%23654321'/%3E%3Ctext x='200' y='320' text-anchor='middle' font-family='Arial' font-size='14' font-weight='bold' fill='white'%3EWOLF PACK%3C/text%3E%3C/svg%3E", description: "United we stand" },
                      { id: 2, title: "TO THE MOON", author: "lunar_wolf", votes: 356, rank: 2, imageUrl: "data:image/svg+xml,%3Csvg viewBox='0 0 400 400' xmlns='http://www.w3.org/2000/svg'%3E%3Crect width='400' height='400' fill='%231a1a2e'/%3E%3Ccircle cx='300' cy='100' r='50' fill='%23f5f5f5'/%3E%3Ccircle cx='150' cy='250' r='60' fill='%23654321'/%3E%3Ctext x='200' y='360' text-anchor='middle' font-family='Arial' font-size='16' font-weight='bold' fill='%23f5f5f5'%3ETO MOON%3C/text%3E%3C/svg%3E", description: "Moon mission activated" },
                      { id: 3, title: "ALPHA ENERGY", author: "energy_alpha", votes: 289, rank: 3, imageUrl: "data:image/svg+xml,%3Csvg viewBox='0 0 400 400' xmlns='http://www.w3.org/2000/svg'%3E%3Crect width='400' height='400' fill='%23FF4500'/%3E%3Cpath d='M200 80 L320 200 L260 260 L200 200 L140 260 L80 200 Z' fill='%23FFD700'/%3E%3Ctext x='200' y='340' text-anchor='middle' font-family='Arial' font-size='16' font-weight='bold' fill='white'%3EALPHA%3C/text%3E%3C/svg%3E", description: "Pure alpha energy" }
                    ]
                  },
                  {
                    id: 28,
                    title: "Contest #28 - October 2024",
                    participants: 89,
                    totalVotes: 2445,
                    status: "Completed", 
                    memes: [
                      { id: 1, title: "SAMU SUPREME", author: "meme_king", votes: 523, rank: 1, imageUrl: "data:image/svg+xml,%3Csvg viewBox='0 0 400 400' xmlns='http://www.w3.org/2000/svg'%3E%3Crect width='400' height='400' fill='%23800080'/%3E%3Ccircle cx='200' cy='200' r='120' fill='%23F7DC6F'/%3E%3Ctext x='200' y='190' text-anchor='middle' font-family='Arial' font-size='20' font-weight='bold'%3ESAMU%3C/text%3E%3Ctext x='200' y='220' text-anchor='middle' font-family='Arial' font-size='16' font-weight='bold'%3ESUPREME%3C/text%3E%3C/svg%3E", description: "The ultimate SAMU" },
                      { id: 2, title: "DIAMOND CLAWS", author: "sharp_wolf", votes: 445, rank: 2, imageUrl: "data:image/svg+xml,%3Csvg viewBox='0 0 400 400' xmlns='http://www.w3.org/2000/svg'%3E%3Crect width='400' height='400' fill='%23191970'/%3E%3Cpolygon points='200,80 280,160 200,240 120,160' fill='%2300BFFF'/%3E%3Cpath d='M180 280 L200 260 L220 280 L210 300 L190 300 Z' fill='%23C0C0C0'/%3E%3Ctext x='200' y='340' text-anchor='middle' font-family='Arial' font-size='14' font-weight='bold' fill='white'%3ECLAWS%3C/text%3E%3C/svg%3E", description: "Sharp as diamonds" },
                      { id: 3, title: "BULL RUN", author: "market_bull", votes: 378, rank: 3, imageUrl: "data:image/svg+xml,%3Csvg viewBox='0 0 400 400' xmlns='http://www.w3.org/2000/svg'%3E%3Crect width='400' height='400' fill='%23228B22'/%3E%3Cpath d='M100 200 L300 100 L320 120 L200 250 L80 220 Z' fill='%2332CD32'/%3E%3Ctext x='200' y='320' text-anchor='middle' font-family='Arial' font-size='18' font-weight='bold' fill='white'%3EBULL RUN%3C/text%3E%3C/svg%3E", description: "Bull market vibes" }
                    ]
                  }
                ].concat(Array.from({length: 27}, (_, i) => ({
                  id: 27 - i,
                  title: `Contest #${27 - i} - ${['September', 'August', 'July', 'June', 'May', 'April', 'March', 'February', 'January', 'December', 'November', 'October', 'September', 'August', 'July', 'June', 'May', 'April', 'March', 'February', 'January', 'December', 'November', 'October', 'September', 'August', 'July'][i]} ${i < 12 ? '2024' : '2023'}`,
                  participants: Math.floor(Math.random() * 60) + 30,
                  totalVotes: Math.floor(Math.random() * 2000) + 800,
                  status: "Completed",
                  memes: [
                    {
                      id: 1,
                      title: ["SAMU WARRIOR", "DIAMOND LEGEND", "WOLF ALPHA", "MOON HUNTER", "CRYPTO BEAST", "PACK ELITE", "GOLDEN WOLF", "STELLAR SAMU", "APEX PREDATOR", "LUNAR LEGEND"][Math.floor(Math.random() * 10)],
                      author: ["crypto_hero", "diamond_soul", "wolf_spirit", "moon_walker", "alpha_king", "legend_wolf", "gold_hunter", "star_wolf", "apex_leader", "lunar_god"][Math.floor(Math.random() * 10)],
                      votes: Math.floor(Math.random() * 300) + 200,
                      rank: 1,
                      imageUrl: `data:image/svg+xml,%3Csvg viewBox='0 0 400 400' xmlns='http://www.w3.org/2000/svg'%3E%3Crect width='400' height='400' fill='%23${['FF6B35', 'F7DC6F', '667BC6', '8B4513', '27ae60', '2C3E50', 'E74C3C', '9B59B6', '1ABC9C', 'F39C12'][Math.floor(Math.random() * 10)]}'/%3E%3Ccircle cx='200' cy='200' r='80' fill='%23${['FFD700', 'C0C0C0', 'CD7F32', '00BFFF', 'FF4500', '32CD32', 'FF1493', '8A2BE2', '00CED1', 'FF8C00'][Math.floor(Math.random() * 10)]}'/%3E%3Ctext x='200' y='210' text-anchor='middle' font-family='Arial' font-size='16' font-weight='bold' fill='white'%3EWINNER%3C/text%3E%3C/svg%3E`,
                      description: "Epic winner meme"
                    },
                    {
                      id: 2,
                      title: ["SILVER WOLF", "CRYSTAL PACK", "STORM RIDER", "NIGHT HUNTER", "SHADOW ALPHA", "SILVER MOON", "ICE WOLF", "THUNDER PACK", "STEEL CLAWS", "FROST BITE"][Math.floor(Math.random() * 10)],
                      author: ["silver_knight", "crystal_wolf", "storm_lord", "night_shade", "shadow_king", "moon_silver", "ice_hunter", "thunder_wolf", "steel_alpha", "frost_wolf"][Math.floor(Math.random() * 10)],
                      votes: Math.floor(Math.random() * 200) + 120,
                      rank: 2,
                      imageUrl: `data:image/svg+xml,%3Csvg viewBox='0 0 400 400' xmlns='http://www.w3.org/2000/svg'%3E%3Crect width='400' height='400' fill='%23${['34495E', '5D6D7E', '2E4053', '1B2631', '273746', '212F3D', '1C2833', '17202A', '0B1426', '85929E'][Math.floor(Math.random() * 10)]}'/%3E%3Cpolygon points='200,100 250,150 200,200 150,150' fill='%23C0C0C0'/%3E%3Ctext x='200' y='280' text-anchor='middle' font-family='Arial' font-size='14' font-weight='bold' fill='white'%3ESILVER%3C/text%3E%3C/svg%3E`,
                      description: "Strong second place"
                    },
                    {
                      id: 3,
                      title: ["BRONZE PACK", "COPPER WOLF", "EARTH SPIRIT", "ROCK SOLID", "IRON WILL", "STONE COLD", "METAL WOLF", "SOLID GROUND", "TOUGH ALPHA", "HARD CORE"][Math.floor(Math.random() * 10)],
                      author: ["bronze_wolf", "copper_alpha", "earth_king", "rock_lord", "iron_wolf", "stone_alpha", "metal_king", "solid_wolf", "tough_alpha", "hard_wolf"][Math.floor(Math.random() * 10)],
                      votes: Math.floor(Math.random() * 150) + 80,
                      rank: 3,
                      imageUrl: `data:image/svg+xml,%3Csvg viewBox='0 0 400 400' xmlns='http://www.w3.org/2000/svg'%3E%3Crect width='400' height='400' fill='%23${['8B4513', 'A0522D', 'CD853F', 'D2691E', 'DEB887', 'F4A460', 'DAA520', 'B8860B', 'FFD700', 'F0E68C'][Math.floor(Math.random() * 10)]}'/%3E%3Ccircle cx='200' cy='200' r='60' fill='%23CD7F32'/%3E%3Ctext x='200' y='280' text-anchor='middle' font-family='Arial' font-size='14' font-weight='bold' fill='white'%3EBRONZE%3C/text%3E%3C/svg%3E`,
                      description: "Solid bronze finish"
                    }
                  ]
                }))).map((contest, index) => (
                  <button
                    key={contest.id}
                    onClick={() => setSelectedArchiveContest(contest)}
                    className="w-full"
                  >
                      ...
                      <CardContent className="p-4">
                        <div className="flex items-center justify-between">
                          <div className="text-left">
                            ...
                            <p className="text-sm text-muted-foreground">{contest.participants} participants • {contest.totalVotes.toLocaleString()} votes</p>
                          </div>
                ...
                {/* Keep original contest for compatibility */}
                <button
