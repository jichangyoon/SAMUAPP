...
import { User, Vote, Trophy, Upload, Settings, Camera, Save, ArrowLeft, Copy, Send, Trash2, MoreVertical, Image as ImageIcon, RefreshCw, Coins, BarChart2, Palette, TrendingUp, ShoppingBag, CheckCircle2, XCircle, X } from "lucide-react";
