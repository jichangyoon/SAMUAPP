...
- **Smart Contract Integration (Phase 2 - Planned Deployment):** A new Solana program (`samu-rewards`) is developed for native SOL distribution, utilizing PDAs for escrow pools and allocation records. This shifts claiming gas fees to the user and ensures on-chain transparency for reward distribution.
